  ...
  return (
    <div className="min-h-screen selection:bg-gold selection:text-black">
      ...
      <header className="relative min-h-screen flex flex-col items-center justify-center text-center pt-20 overflow-hidden">
        ...
        >
          <span className="text-gold font-mono text-sm tracking-[0.3em] uppercase mb-4 block">Som Profissional ao seu Alcance</span>
          <h1 className="text-5xl md:text-7xl font-serif italic font-bold mb-6 leading-tight max-w-4xl mx-auto">
          ...
          <div className="w-full max-w-4xl mx-auto rounded-2xl overflow-hidden shadow-2xl border border-white/10 mb-12 bg-black/20">
          ...
          <button 
            ...
            className="btn-premium px-10 py-5 rounded-full text-black font-bold text-lg uppercase tracking-wider"
          >
      ...
      <Section className="text-center">
        <h2 className="text-3xl md:text-5xl font-serif italic mb-8">O Que é o SoundPack Premium?</h2>
        <p className="text-lg text-white/60 max-w-3xl mx-auto leading-relaxed mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {[
            { icon: <Music className="w-8 h-8" />, title: "Som Profissional", desc: "Timbres de nível internacional em qualquer lugar." },
            { icon: <Zap className="w-8 h-8" />, title: "Criatividade", desc: "Novas texturas para suas composições e arranjos." },
            { icon: <Smartphone className="w-8 h-8" />, title: "Configuração Rápida", desc: "Mude seus presets em segundos pelo celular." },
            { icon: <Layers className="w-8 h-8" />, title: "Biblioteca Completa", desc: "Pianos, pads, cordas e leads em um só lugar." }
          ].map((item, i) => (
      ...
      {/* Stats */}
      <div className="bg-premium-gray py-12 border-y border-white/5">
        <div className="max-w-7xl mx-auto px-6 flex flex-wrap justify-around items-center gap-8">
          <div className="text-center">
            ...
            <p className="text-white/50 uppercase tracking-widest text-xs mt-2">Tecladistas Satisfeitos</p>
          </div>
          <div className="text-center">
            <span className="text-4xl font-bold text-gold">
              <Counter value={2.49} decimals={2} prefix="+" />
            </span>
            <p className="text-white/50 uppercase tracking-widest text-xs mt-2">GB de Sons Puros</p>
          </div>
          <div className="text-center">
            <span className="text-4xl font-bold text-gold">
              <Counter value={100} suffix="%" />
            </span>
            <p className="text-white/50 uppercase tracking-widest text-xs mt-2">Qualidade Digital</p>
          </div>
        </div>
      </div>
      ...
      <Section>
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-serif italic mb-4">Explore sua Nova Paleta Sonora</h2>
          <p className="text-white/60">Timbres meticulosamente sampleados para máxima fidelidade.</p>
        </div>
      ...
      <Section className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <Card className="text-center">
          <Smartphone className="w-10 h-10 text-gold mx-auto mb-6" />
          <h3 className="text-xl font-bold mb-4">Funciona no Celular?</h3>
          <p className="text-white/60 text-sm">Sim! Compatível com Android e iOS. Você recebe um módulo exclusivo para cada sistema.</p>
        </Card>
        <Card className="text-center">
          <Keyboard className="w-10 h-10 text-gold mx-auto mb-6" />
          <h3 className="text-xl font-bold mb-4">Funciona no meu Teclado?</h3>
          <p className="text-white/60 text-sm">Sim! Em qualquer teclado ou controlador que possua conexão MIDI/USB.</p>
        </Card>
        <Card className="text-center">
          <Users className="w-10 h-10 text-gold mx-auto mb-6" />
          <h3 className="text-xl font-bold mb-4">Para quem é este Pack?</h3>
          <p className="text-white/60 text-sm">Tecladistas que buscam som profissional sem carregar equipamentos pesados e caros.</p>
        </Card>
      </Section>

      {/* O que vai receber */}
      <Section className="bg-premium-gray/50 rounded-3xl border border-white/5">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-serif italic mb-4">O Que Você Vai Receber?</h2>
          <p className="text-white/60">Um ecossistema completo para sua evolução musical.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="text-center">
            ...
            <h4 className="text-xl font-bold mb-3">Pack de Timbres</h4>
            <p className="text-white/50 text-sm">Biblioteca completa com pianos, pads, leads e muito mais.</p>
          </div>
          <div className="text-center">
            <div className="w-16 h-16 bg-gold/10 rounded-full flex items-center justify-center mx-auto mb-6">
              <Video className="w-8 h-8 text-gold" />
            </div>
            <h4 className="text-xl font-bold mb-3">Videoaula Exclusiva</h4>
            <p className="text-white/50 text-sm">Treinamento passo a passo para configurar e usar o app corretamente.</p>
          </div>
          <div className="text-center">
            <div className="w-16 h-16 bg-gold/10 rounded-full flex items-center justify-center mx-auto mb-6">
              <MessageCircle className="w-8 h-8 text-gold" />
            </div>
            <h4 className="text-xl font-bold mb-3">Suporte VIP</h4>
            <p className="text-white/50 text-sm">Acesso direto via WhatsApp para tirar qualquer dúvida técnica.</p>
          </div>
        </div>
      </Section>
      ...
      <Section className="text-center">
        <div className="mb-12">
          <h2 className="text-3xl md:text-5xl font-serif italic mb-4">Veja na Prática</h2>
          <p className="text-white/60">Assista à demonstração real dos timbres em ação.</p>
        </div>
        <div className="max-w-4xl mx-auto aspect-video rounded-3xl overflow-hidden border border-gold/20 shadow-2xl shadow-gold/5">
          <iframe 
      ...
      <Section>
        <div className="flex items-center justify-center gap-4 mb-12">
          ...
          <h2 className="text-3xl font-serif italic">Presentes Exclusivos (Bônus)</h2>
          <Gift className="w-8 h-8 text-gold" />
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Card className="flex flex-col md:flex-row gap-8 items-center bg-gold/5">
            <img src="https://eliabcamposteclas.com/wp-content/uploads/2026/03/ChatGPT-Image-24-de-mar.-de-2026-12_27_37.jpg" alt="Bônus 1" className="w-48 h-48 rounded-xl object-cover" referrerPolicy="no-referrer" />
            <div>
              <span className="text-gold font-mono text-xs uppercase tracking-widest mb-2 block">Grátis</span>
              <h4 className="text-2xl font-bold mb-4">Timbres de Metais & Órgãos</h4>
              <p className="text-white/60 text-sm leading-relaxed">Sons potentes e realistas para ampliar sua versatilidade em qualquer estilo musical.</p>
            </div>
          </Card>
          <Card className="flex flex-col md:flex-row gap-8 items-center bg-gold/5">
            <img src="https://eliabcamposteclas.com/wp-content/uploads/2026/03/ChatGPT-Image-24-de-mar.-de-2026-12_29_50.jpg" alt="Bônus 2" className="w-48 h-48 rounded-xl object-cover" referrerPolicy="no-referrer" />
            <div>
              <span className="text-gold font-mono text-xs uppercase tracking-widest mb-2 block">Grátis</span>
              <h4 className="text-2xl font-bold mb-4">Pads Contínuos (Infinite)</h4>
              <p className="text-white/60 text-sm leading-relaxed">Ambientes perfeitos para worship, intros e transições suaves em todos os tons.</p>
            </div>
          </Card>
        </div>
      </Section>
      ...
      <Section className="flex flex-col md:flex-row items-center gap-16">
        ...
        <div className="w-full md:w-1/2">
          <span className="text-gold font-mono text-sm tracking-widest uppercase mb-4 block">Seu Mentor</span>
          <h2 className="text-4xl md:text-6xl font-serif italic mb-8">Eliab Campos</h2>
      ...
      <Section className="overflow-hidden">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-serif italic mb-4">O Que Estão Dizendo</h2>
          <p className="text-white/60">Centenas de tecladistas já transformaram seu som.</p>
        </div>
          ...
          <div className="flex overflow-hidden">
            ...
            >
              {[
                ...
                <div key={i} className="w-[300px] md:w-[400px] flex-shrink-0 rounded-2xl overflow-hidden border border-white/10 glass">
                  <img 
                    src={img} 
                    alt={`Depoimento ${i + 1}`} 
              ...
              {[
                ...
                <div key={`dup-${i}`} className="w-[300px] md:w-[400px] flex-shrink-0 rounded-2xl overflow-hidden border border-white/10 glass">
                  <img 
                    src={img} 
                    alt={`Depoimento ${i + 1}`} 
                    className="w-full h-auto object-cover"
      ...
      {/* Oferta Final */}
      <Section id="offer" className="text-center">
        <Card className="max-w-3xl mx-auto py-16 px-8 border-gold/30 bg-gold/5 relative overflow-hidden">
          <div className="absolute top-0 right-0 p-4">
            <Star className="w-12 h-12 text-gold/20" />
          </div>
          
          <span className="bg-gold text-black px-4 py-1 rounded-full text-xs font-bold uppercase tracking-widest mb-8 inline-block">
            Oferta por Tempo Limitado
          </span>
          
          <h2 className="text-4xl md:text-6xl font-serif italic mb-8">Invista no seu Som</h2>
          ...
          <div className="mb-10">
            <span className="text-white/40 line-through text-xl block mb-2">De R$ 197,00</span>
            <div className="flex items-center justify-center gap-2">
              <span className="text-2xl font-bold text-gold">R$</span>
              <span className="text-7xl font-bold gold-gradient">37,90</span>
            </div>
            <p className="text-white/40 text-sm mt-4">Acesso imediato após a confirmação</p>
          </div>
          
          <button className="btn-premium w-full md:w-auto px-16 py-6 rounded-full text-black font-bold text-xl uppercase tracking-widest mb-6">
      ...
      {/* Garantia */}
      <Section className="flex flex-col md:flex-row items-center gap-12 bg-premium-gray/30 rounded-3xl border border-white/5">
        ...
        <div className="w-full md:w-2/3 text-center md:text-left">
          <h2 className="text-3xl md:text-5xl font-serif italic mb-6">Risco Zero: <span className="text-gold">30 Dias de Garantia</span></h2>
          <p className="text-lg text-white/70 leading-relaxed mb-6">
